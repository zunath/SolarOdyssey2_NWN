    ...
    public class StructureService : IStructureService
    {
        ...
        public void OnModuleLoad()
        {
            ...
            foreach (PCTerritoryFlag flag in territoryFlags)
            {
                ...
                NWPlaceable territoryFlag = NWPlaceable.Wrap(_.CreateObject(OBJECT_TYPE_PLACEABLE, flag.StructureBlueprint.Resref, location));
        ...
        public NWObject GetTerritoryFlagOwnerOfLocation(Location location)
        {
            ...
            foreach (PCTerritoryFlag flag in areaFlags)
            {
                ...
                if (distance <= flag.StructureBlueprint.MaxBuildDistance)
                {
                    ...
                    NWPlaceable checker = NWPlaceable.Wrap(_.CreateObject(OBJECT_TYPE_PLACEABLE, TemporaryLocationCheckerObjectResref, location));

                    do
                    {
                        placeable = NWPlaceable.Wrap(_.GetNearestObject(OBJECT_TYPE_PLACEABLE, checker.Object, currentPlaceable));
        ...
        public void CreateConstructionSiteFromEntity(ConstructionSite entity)
        {
            ...
            NWPlaceable constructionSite = NWPlaceable.Wrap(_.CreateObject(OBJECT_TYPE_PLACEABLE, ConstructionSiteResref, location));
            ...
            _.ApplyEffectToObject(DURATION_TYPE_PERMANENT, eGhostWalk, constructionSite.Object);
        ...
        public void CreateStructureFromEntity(PCTerritoryFlagsStructure structure)
        {
            ...
            NWPlaceable structurePlaceable = NWPlaceable.Wrap(_.CreateObject(OBJECT_TYPE_PLACEABLE, structure.StructureBlueprint.Resref, location));
        ...
        public NWPlaceable CreateBuildingDoor(Location houseLocation, int structureID)
        {
            ...
            NWPlaceable door = NWPlaceable.Wrap(_.CreateObject(OBJECT_TYPE_PLACEABLE, "building_door", doorLocation));
        ...
        public NWPlaceable CompleteStructure(NWPlaceable constructionSite)
        {
            ...
            NWPlaceable structurePlaceable = NWPlaceable.Wrap(_.CreateObject(OBJECT_TYPE_PLACEABLE, blueprint.Resref, location));
        ...
        public void MoveStructure(NWPlayer oPC, Location location)
        {
            ...
            NWPlaceable copy = NWPlaceable.Wrap(_.CreateObject(OBJECT_TYPE_PLACEABLE, target.Resref, location));
        ...
        public void RazeTerritory(NWPlaceable flag)
        {
            ...
            while (placeable.IsValid)
            {
                ...
                currentPlaceable++;
                placeable = NWPlaceable.Wrap(_.GetNearestObject(OBJECT_TYPE_PLACEABLE, flag.Object, currentPlaceable));
            }
