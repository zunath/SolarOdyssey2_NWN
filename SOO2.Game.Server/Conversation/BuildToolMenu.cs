...
namespace Freescape.Game.Server.Conversation
{
    public class BuildToolMenu: ConversationBase
    {
        ...
        private void HandleMoveStructure()
        {
            ...
            _.FloatingTextStringOnCreature("Please use your build tool to select a new location for this structure.", GetPC().Object, FALSE);
        ...
        private void HandleRazeStructure()
        {
            ...
            {
                _.FloatingTextStringOnCreature("You do not have permission to raze this structure.", oPC.Object, FALSE);
                BuildMainMenuResponses(null);
                ChangePage("MainPage");
                return;
            }
