...
namespace Freescape.Game.Server.Conversation
{
    internal class ChangeHead: ConversationBase
    {
        ...
        public override void Initialize()
        {
            ...
            model.OriginalHeadID = _.GetCreatureBodyPart(CREATURE_PART_HEAD, GetPC().Object);
        ...
        private void ChangeHeadID(int adjustBy)
        {
            ...
            _.SetCreatureBodyPart(CREATURE_PART_HEAD, model.CurrentHeadID, oPC.Object);
            SetPageHeader("MainPage", BuildHeader());
        }
        ...
        private void ResetHeadID()
        {
            ...
            _.SetCreatureBodyPart(CREATURE_PART_HEAD, dto.OriginalHeadID, oPC.Object);
            SetPageHeader("MainPage", BuildHeader());
        }
